                ...
                <div class="col-lg-8 col-md-8 sm-mt-75">
                    <div class="contact-form style-3">
                        <form id="harvestform">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" placeholder="Harvest ID" id="harvestid" />
                                </div>
                                <div class="col-lg-6">
                                    <input type="text" placeholder="NIC No" id="nic" />
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="date" placeholder="Date" id="subject" />
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" placeholder="Unit Price (Rs per kg)" id="unitprice" />
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    <button class="btn-common" id="add">ADD</button>
                                </div>
                                <div class="col-lg-4">
                                    <button class="btn-common" id="update">Update</button>
                                </div>
                                <div class="col-lg-4">
                                    <button class="btn-common" id="clear">CLEAR</button>
                                </div>
